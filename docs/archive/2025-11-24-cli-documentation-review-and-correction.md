...
Active document: None (Review Completed)
...
- [x] `docs/cli/start-assets-update.md` - Update assets
...
- [x] `docs/cli/start-config-role.md` - Role configuration
- [x] `docs/cli/start-config-task.md` - Task configuration
...
- [x] All 20 documents (3 root + 17 CLI) reviewed and corrected
- [x] Examples are accurate and tested conceptually
- [x] Flags and options are consistent across commands
- [x] Multi-file config structure correctly documented
- [x] Catalog behavior (lazy loading, browsing) accurately described
- [x] Design decisions referenced where relevant
- [x] No contradictions between documents
- [x] Design records updated to reflect changes
...
- **Replaced [scope] with [flags] and --local**: Standardized command structure by removing positional `[scope]` arguments in favor of explicit `[flags]` and `--local` flag for all configuration commands.
- `docs/design/design-records/dr-017-cli-reorganization.md`: Updated to reflect `--local` flag usage instead of `[scope]`.
